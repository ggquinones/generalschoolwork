...
PICKLEFILE = 'c:\\users\\gabriel\\desktop\\senior design\\md.pickle.gz'  # The Python dict produced by this module
RDFFILES = 'c:\\users\\gabriel\\desktop\\senior design\\rdf-files.tar.bz2'  # The catalog downloaded from Gutenberg
