<?php
	...
	if((recognizedUserInGroup($user_name,$groupID)) && (!hasSignedInToday($user_name)))
	{
		$sql =
		"
			INSERT INTO csscSignIn(ipfwUsername, groupId,task) 
			VALUES ('$user_name','$groupID','$task')
		";

		if(mysqli_query($con, $sql))
		{
			$flag = "You signed in successfully! Hello!";
		}
	...
	else if(hasSignedInToday($user_name))
	{
		$flag ="Error occured. You have already signed in today!";
	}
	else
	{
